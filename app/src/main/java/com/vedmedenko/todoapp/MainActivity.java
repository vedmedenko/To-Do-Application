package com.vedmedenko.todoapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static class TaskHolder extends RecyclerView.ViewHolder {
        ...
        public TaskHolder(View itemView) {
            super(itemView);
            tv_name = (TextView) itemView.findViewById(R.id.textViewName);
            tv_description = (TextView) itemView.findViewById(R.id.textViewDescription);
            cb_isDone = (CheckBox) itemView.findViewById(R.id.checkBoxIsDone);
        }
        ...
        public void setOnCheckboxClick(CompoundButton.OnCheckedChangeListener onCheckedChangeListener) {
            cb_isDone.setOnCheckedChangeListener(onCheckedChangeListener);
        }

        public void setIsDone(@NonNull Boolean isDone) {
            cb_isDone.setChecked(isDone);
        }
    }
}
